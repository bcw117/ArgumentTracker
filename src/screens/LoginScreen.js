...
const LoginScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={login.container}>
      <Text style={{ fontFamily: "Nexa-Bold", fontSize: 50, marginBottom: 25 }}>
        ArgTrack
      </Text>
      <KeyboardAvoidingView
      ...
      >
        ...
        <View>
          <Pressable style={login.button} onPress={handleSignIn}>
            <Text style={login.text}>Sign In</Text>
          </Pressable>
        </View>
        <View>
          <Pressable
          ...
          >
            <Text style={login.text}>Don't have an account? Create one</Text>
          </Pressable>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
