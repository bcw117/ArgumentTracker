...
const ChangePasswordScreen = ({ navigation }) => {
  ...
  const confirmNewPassword = () => {
    ...
    if (newPass === prevPass) {
      return alert("Your new password cannot be the same as your old password");
    } else if (newPass !== confirmPass) {
      return alert("Your confirmation password does not match");
    }
    updatePassword(auth.currentUser, newPass)
      .then(() => {
        alert("Your password has been updated").then(() => {
